...
var ValidatorDateBefore = function () {
  function ValidatorDateBefore(name, date) {
    _classCallCheck(this, ValidatorDateBefore);
  ...
  _createClass(ValidatorDateBefore, [{
    key: 'isValid',
  ...
  return ValidatorDateBefore;
}();

exports.default = ValidatorDateBefore;